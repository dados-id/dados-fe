import { Body, Chip, Header, RatingCard } from "@components"
        ...
        <div className="flex flex-row gap-6 w-full rounded-xl p-4 border  border-grey-200">
            ...
            <div className="flex flex-col justify-between w-max h-full gap-2">
                ...
                <Body preset="p2">
                    ...
                    Phasellus sed augue id justo vulputate cursus. Ut sed
                    dignissim nisl, ut iaculis tellus. Nunc luctus ligula eu ex
                    gravida euismod. Aliquam eros arcu, iaculis vitae turpis et,
                    vehicula ultrices erat. Nulla id aliquam sapien.
                </Body>
