...
export const ReviewCard = () => {
  return (
    <div className="flex flex-row gap-6 w-full rounded-xl p-4 border  border-grey-200">
      <div className="h-42 w-36 bg-mariana rounded-xl">
      </div>
      <div className="flex flex-col justify-between w-1/2">
        <div className="flex flex-row justify-between items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  className="w-5 h-5 fill-success">
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-danger">
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-warning">
      ...
      <div className="flex flex-col justify-between w-max h-full gap-2">
